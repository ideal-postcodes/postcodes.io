...
var listOutcodeAttributes = "SELECT DISTINCT $1 FROM postcodes WHERE postcodes.outcode=$2";
var additionalAttributes = ["admin_ward"];

function generateOutcodeQueries() {
